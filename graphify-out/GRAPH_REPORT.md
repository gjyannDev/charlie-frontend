...
## Corpus Check
- 72 files · ~23,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 317 nodes · 442 edges · 25 communities (19 shown, 6 thin omitted)
...
### Community 0 - "cn"
Cohesion: 0.08
Nodes (40): Checkbox(), Field(), FieldContent(), FieldDescription(), FieldError(), FieldGroup(), FieldLabel(), FieldLegend() (+32 more)
...
Cohesion: 0.14
Nodes (19): AuthForm(), getErrorMessage(), LoginStep, Button(), buttonVariants, authKeys, useCheckEmailMutation(), useSignInMutation() (+11 more)

### Community 16 - "AGENTS.md"
Cohesion: 0.50
Nodes (3): Charlie Frontend Agent Instructions, Domain Module Placement, This is NOT the Next.js you know
...
## Knowledge Gaps
- **137 isolated node(s):** `fs`, `fs`, `path`, `uaDir`, `intermediate` (+132 more)
